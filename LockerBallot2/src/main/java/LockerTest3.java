...
public class LockerTest3 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String hash = CitaUtil.sendContract(service,privateKey,multiSigWalletCode,inputParameters);
        ...
        Address address4 = new Address("0x558D51dB15BbaF7248c7f6B853b04451aA70B438");
        Address address5 = new Address("0x66F751BA888960C22cE4B675B404ccE16bBbD942");
        Address address6 = new Address("0x0ddC553E3EFf90f5Ab246a426cC3Bd5cC53769fD");
        List<Address> willAddAddressList = new ArrayList<>();
        willAddAddressList.add(address4);
        willAddAddressList.add(address5);
        willAddAddressList.add(address6);
        for (Address addr : willAddAddressList) {
            inputParameters = new ArrayList<>();
            inputParameters.add(addr);

            String funHexStr1 = CitaUtil.getFunHexStr("addOwner",inputParameters, new TypeReference<Type>(){});
            String addOwnerHash = CitaUtil.sendTransaction(service,privateKey,address,funHexStr1);
            TimeUnit.SECONDS.sleep(10);
            TransactionReceipt transactionReceipt = CitaUtil.appGetTransactionReceiptByHash(service,addOwnerHash);
            if(transactionReceipt.getErrorMessage() != null){
                System.err.println("addOwner " + addr + " error : " + transactionReceipt.getErrorMessage());
            }
        }
        System.out.println();
